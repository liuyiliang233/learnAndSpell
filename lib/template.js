class word_card extends HTMLElement {
    constructor() {
        ...
        this.querySelector("#spell_b").onclick = () => {
            ...
            if (mode) {
                if (spell) {
                    this.spell_s();
                    document.querySelector("#spellWord").focus();
                } else {
                    this.spell_s_h();
                }
            }
        ...
        this.querySelector("#spellWord").oninput = this.check = (v) => {
            ...
            //错误归位
            if ((inputWord.length <= word.length || v) && inputWord !== word.slice(0, inputWord.length)) {
                syllable(word, el);
                el.querySelector("#word").style = "font-size: var(--word-s)";
                el.querySelector("#phonetic").innerHTML = phonetic;
    ...
    s_h() {
        ...
        this.querySelector("#word").style.fontFamily = "monospace";
